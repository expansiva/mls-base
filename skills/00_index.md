...
| `agentPlannerL2` (P2) | `mls-102020` | `l4/<mod>/pool/l2/menu.json` menu v2 (tree of hubs/pages/organisms, authorities by actor) from a complete l4 and `pool/l2` (does not delete the pool or write `pool/l1` during the marco) | this index; code in `mls-102020/l2/agentPlannerL2` (`entry10` + `menu20`; `workspaces20`/`contracts30`/`shared40`/`requests50` parked as of 18/09/2026) |
