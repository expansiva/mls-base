 ...
 * https://collab.codes?source=google&code=4/0AY0e-g6hXZL_o1L7X7hVp6...&state=abc123xyz
 * https://collab.codes?source=google&error=access_denied&error_description=The+user+denied+access&state=abc123xyz
 */
...
export const msgAddOrUpdateThreadIntegration: (args: Omit<mls.msg.RequestAddOrUpdateThreadIntegration, "action">) => Promise<mls.msg.ResponseAddOrUpdateThreadIntegration>;
/**
...
export const msgAddMessageAI: (args: Omit<mls.msg.RequestAddMessageAI, "action">) => Promise<mls.msg.ResponseAddMessageAI>;
export const msgAddMessage: (args: Omit<mls.msg.RequestAddMessage, "action">) => Promise<mls.msg.ResponseAddMessage>;
export const msgUpdateMessage: (args: Omit<mls.msg.RequestUpdateMessage, "action">) => Promise<mls.msg.ResponseUpdateMessage>;
export const msgAddUser: (args: Omit<mls.msg.RequestAddUser, "action">) => Promise<mls.msg.ResponseAddUser>;
export const msgAddThread: (args: Omit<mls.msg.RequestAddThread, "action">) => Promise<mls.msg.ResponseAddThread>;
export const msgGetTaskUpdate: (args: Omit<mls.msg.RequestGetTaskUpdate, "action">) => Promise<mls.msg.ResponseGetTaskUpdate>;
export const msgAddTaskAISteps: (args: Omit<mls.msg.RequestAddTaskAISteps, "action">) => Promise<mls.msg.ResponseAddTaskAISteps>;
export const msgUpdateStepStatus: (args: Omit<mls.msg.RequestUpdateStepStatus, "action">) => Promise<mls.msg.ResponseUpdateStepStatus>;
export const msgAddTaskAIInteraction: (args: Omit<mls.msg.RequestAddTaskAIInteraction, "action">) => Promise<mls.msg.ResponseAddTaskAIInteraction>;
export const msgGetMessage: (args: Omit<mls.msg.RequestGetMessage, "action">) => Promise<mls.msg.ResponseGetMessage>;
export const msgGetMessagesAfter: (args: Omit<mls.msg.RequestGetMessagesAfter, "action">) => Promise<mls.msg.ResponseGetMessagesAfter>;
export const msgGetMessagesBefore: (args: Omit<mls.msg.RequestGetMessagesBefore, "action">) => Promise<mls.msg.ResponseGetMessagesBefore>;
export const msgGetThreadUpdate: (args: Omit<mls.msg.RequestGetThreadUpdate, "action">) => Promise<mls.msg.ResponseGetThreadUpdate>;
export const msgGetUserUpdate: (args: Omit<mls.msg.RequestGetUserUpdate, "action">) => Promise<mls.msg.ResponseGetUserUpdate>;
export const msgGetUsers: (args: Omit<mls.msg.RequestGetUsers, "action">) => Promise<mls.msg.ResponseGetUsers>;
export const msgRemoveUserInThread: (args: Omit<mls.msg.RequestRemoveUserInThread, "action">) => Promise<mls.msg.ResponseRemoveUserInThread>;
export const msgAddUserInThread: (args: Omit<mls.msg.RequestAddUserInThread, "action">) => Promise<mls.msg.ResponseAddUserInThread>;
export const msgAppendPromptToInteraction: (args: Omit<mls.msg.RequestAppendPromptToInteraction, "action">) => Promise<mls.msg.ResponseAppendPromptToInteraction>;
export const msgUpdateUserDetails: (args: Omit<mls.msg.RequestUpdateUserDetails, "action">) => Promise<mls.msg.ResponseUpdateUserDetails>;
export const msgAppendLongTermMemory: (args: Omit<mls.msg.RequestAppendLongTermMemory, "action">) => Promise<mls.msg.ResponseAppendLongTermMemory>;
export const msgUpdateThread: (args: Omit<mls.msg.RequestUpdateThread, "action">) => Promise<mls.msg.ResponseUpdateThread>;
export const msgUpdateTaskTitle: (args: Omit<mls.msg.RequestUpdateTaskTitle, "action">) => Promise<mls.msg.ResponseUpdateTaskTitle>;
export const msgAddOrUpdateThreadBot: (args: Omit<mls.msg.RequestAddOrUpdateThreadBot, "action">) => Promise<mls.msg.ResponseAddOrUpdateThreadBot>;
export const msgApplyIntents: (args: Omit<mls.msg.RequestApplyIntents, "action">) => Promise<mls.msg.ResponseApplyIntents>;
...
// import { mls } from "../../src/index";
/**
 * server sent widgets to update
 */
export function processL2Html(jss: string[]): Promise<void>;
